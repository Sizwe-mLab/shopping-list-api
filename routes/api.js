...
router.post("/lists", listFunctions.createList);
router.get("/lists", listFunctions.getLists);
router.get("/lists/:id", listFunctions.getList);
router.put("/lists/:id", listFunctions.updateList);
router.delete("/lists/:id", listFunctions.deleteList);
router.post("/lists/:listId/items", listFunctions.addItemToList);
router.delete("/lists/:listId/items/:itemId", listFunctions.removeItemFromList);
